...
public class SGT_MultiMesh
{
	...
	[SerializeField]
	private PhysicsMaterial sharedPhysicsMaterial;
	...
	public PhysicsMaterial SharedPhysicsMaterial
	{
		set
		{
	...
	public void Add(Mesh newSharedMesh = null, Material newSharedMaterial = null, PhysicsMaterial newSharedPhysicsMaterial = null)
	{
	...
	public void ReplaceAll(Mesh newSharedMesh, Material newSharedMaterial = null, PhysicsMaterial newSharedPhysicsMaterial = null)
	{
		var newRendererMaterials = newSharedMaterial        != null ? new Material[]       { newSharedMaterial        } : null;
		var newColliderMaterials = newSharedPhysicsMaterial != null ? new PhysicsMaterial[] { newSharedPhysicsMaterial } : null;
		
		ReplaceAll(new Mesh[] { newSharedMesh }, newRendererMaterials, newColliderMaterials);
	}
	
	public void ReplaceAll(Mesh[] newSharedMeshes, Material[] newSharedMaterials = null, PhysicsMaterial[] newSharedPhysicsMaterials = null)
	{
